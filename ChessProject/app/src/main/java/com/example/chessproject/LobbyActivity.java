...
//
        ...
        mUsersDatabaseReference.child(userId).child("username").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.e("USER", "Uname player " + snapshot.getValue());
...
//                                    String player_white = snapshot.getValue(String.class);
                                    ...
                                    final String player_white;
                                    ValueEventListener userdddd = mGamesDatabaseReference.child(offer).child("white").addValueEventListener(new ValueEventListener() {
                                        @Override
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            player_white = snapshot.getValue(String.class);
